...
class BuildingSerializer
  ...
  attribute :locked do |object, params|
    ...
    gates = params && params[:gates] && params[:gates]['Building']
    ...
    if user
      if gates && user_flag_ids
        ...
        if (gate = Unlockable.find_by(unlockable_type: 'Building', unlockable_id: object.id))
  ...
  attribute :requirements do |object, params|
    ...
    flag = if gates
      ...
      (Unlockable.find_by(unlockable_type: 'Building', unlockable_id: object.id)&.flag)
    end
    if flag
